...
@Route(value = "editar-comentario")
@Uses(Icon.class)
public class EditarComentarioView extends Composite<VerticalLayout> {
    TextArea textArea = new TextArea();
    HorizontalLayout layoutRow = new HorizontalLayout();
    Button buttonPrimary = new Button();
    Button buttonSecondary = new Button();
    Comment comentario = TareaView.comentario;

    public EditarComentarioView() {
        ...
        textArea.setValue(comentario.getText());
    }

    private void onButtonPrimaryClick() {
        String textoComentario = textArea.getValue();
        
        TareaView.comentario.setText(textoComentario);
